...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data\cs.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=ROOT / "data/hyps/hyp.scratch-low.yaml", help="hyperparameters path")
    parser.add_argument("--epochs", type=int, default=600, help="total training epochs")
    parser.add_argument("--batch-size", type=int, default=22, help="total batch size for all GPUs, -1 for autobatch")
